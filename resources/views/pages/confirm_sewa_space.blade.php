...
@section('title', 'Detail Sewa Studio Space')

@section('content')
<div class="container mx-auto mt-4 px-4">
  <a href="/detail_studio_space" class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">
  ...
  <div class="container mx-auto mt-4 px-4">
    ...
    <div class="bg-primary text-white p-4 rounded-3xl flex flex-col md:flex-row items-center justify-between">
      <div class="w-1/2 h-[415px] overflow-hidden rounded-3xl ml-25">
        <img src="images/gambar11.jpeg" alt="Terrena" class="w-full h-full object-cover rounded-3xl">
      </div>
      <div class="text-white p-5 mt-4 md:mt-0 max-w-md w-full mr-32">
        <h3 class="text-lg font-bold mb-5">Terrena</h3>
        <div class="mb-3">
        ...
        <form action="confirm_sewa_space.php" method="POST" enctype="multipart/form-data">
