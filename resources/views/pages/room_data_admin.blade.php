	...
	<dialog id="editModal" class="modal w-full max-w-md rounded-lg">
		<form id="editForm" method="POST" enctype="multipart/form-data" class="bg-white text-primary p-6 rounded shadow-xl">
			...
			<div class="mb-3">
				...
				{{-- All In --}}
				<div class="flex items-center mb-2">
					<input id="edit_all_in" type="checkbox" class="w-4 h-4 text-blue-600 border-gray-300 rounded" />
					<label for="edit_all_in" class="ms-2 text-sm font-medium text-gray-900">All In</label>
				</div>

				{{-- No Session --}}
				<div class="flex items-center mb-2">
					<input id="edit_no_session" type="checkbox" class="w-4 h-4 text-blue-600 border-gray-300 rounded" />
			...
			<div class="mb-2">
				<label for="edit_photo" class="block mb-1">Photo (optional)</label>
